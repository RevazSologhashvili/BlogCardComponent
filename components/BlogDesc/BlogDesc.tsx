...
const BlogDesc = (props: blogDescription) => {
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="bg-[#F4D04E] w-fit px-3 py-1 rounded font-[800] text-[#111111] sm:text-[14px] text-[12px]">
        {props.blogCategory}
      </div>
      <span className="text-[#111111] text-sm font-[500] sm:text-[14px] text-[12px]" >
      {props.publishedDate}
      </span>
